...
public class TestWidgetGroupC extends FrameLayout {
    public static final String TAG = "SchafferGroupC";

    private VelocityTracker vTracker;

    public TestWidgetGroupC(@NonNull Context context) {
        this(context,null);
    }

    public TestWidgetGroupC(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TestWidgetGroupC(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
