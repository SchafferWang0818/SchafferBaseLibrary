...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        titleTextSize = a.getDimension(R.styleable.ExpandTextView_titleTextSize, ConvertUtils.sp2px(DEFAULT_TITLE_TEXT_SIZE));
        contentTextSize = a.getDimension(R.styleable.ExpandTextView_contentTextSize, ConvertUtils.sp2px(DEFAULT_CONTENT_TEXT_SIZE));
        hintTextSize = a.getDimension(R.styleable.ExpandTextView_hintTextSize, ConvertUtils.sp2px(DEFAULT_HINT_TEXT_SIZE));
     ...
     */
    private void init() {
        View.inflate(mContext, R.layout.layout_expand_text_view, this);
        mTitleView = (TextView) findViewById(R.id.expand_tv_title);
        mContentView = (TextView) findViewById(R.id.expand_tv_content);
        mHintView = (TextView) findViewById(R.id.expand_tv_more_hint);
        mIndicateImage = (ImageView) findViewById(R.id.expand_iv_arrow_more);
        mShowMore = (RelativeLayout) findViewById(R.id.expand_rl_show_more);
        ...
        if (indicateImage == null) {
            indicateImage = getResources().getDrawable(R.drawable.icon_detail_down);
        }
    ...
    public void setTitleTextSize(float titleTextSize) {
        this.titleTextSize = ConvertUtils.sp2px(titleTextSize);
    ...
    public void setContentTextSize(float contentTextSize) {
        this.contentTextSize = ConvertUtils.sp2px(contentTextSize);
    ...
    public void setHintTextSize(float hintTextSize) {
        this.hintTextSize = ConvertUtils.sp2px(hintTextSize);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.expand_rl_show_more) {
            expand();
        }
    }
    ...
    public int getMinMeasureHeight() {
        if (copy == null) {
            ...
            copy.setLineSpacing(ConvertUtils.dp2px(6), 1.0f);
    ...
    private void expand() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.d("Fraction", ">>" + animatedFraction);
                if (mListener != null && animatedFraction == 1) {
                    if (flag) {
                        //expand
                        mListener.onExpand();
